...
fun main() {
     ...
     *
     */
    hero.setProfile("Nisaul Faadhilah", 20, 158, 20)
    ...
    **/
    ...
    val classBAfternoonActivities = listOf("jalan", "lari", "makan", "minum", "lompat", "duduk")
    val classBAfternoonCounts = listOf(4, 1, 3 ,5 ,5 ,3)
    runchallange(hero, classBAfternoonActivities, classBAfternoonCounts)
